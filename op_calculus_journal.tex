...
\keywords{
  ...
  \acknowledgement{
  First author extends his gratitude to dr. Jure Kališnik for proofreading the proofs, and prof. Borut Robič for general guidance through the academia.
  }
...
\end{equation}
 ...
 \begin{equation}
\exp(\D_fe^{h\D_g})(f,\cdot)=f_*\left( e^{d\D} \right)\label{eq:opKompoForward}
\end{equation} is the
...
appropriate derivative, as it measures the rate of change. 
   ...
   Google's Deep Dream Project \cite{DeepDream} works. 
