...
\begin{definicija}[Euclidean virtual machine] The tuple $(\VV,\F)$ is an Euclidean virtual machine, where
  \begin{itemize}
  \item
...
$\vv_0$ with activation functions $\Phi$. When the choice of $(\Phi,P,\mathbf{v_0})$ is arbitrary, we simply denote it $\NN\in\dP_0$, as any general tensor network is a truncated Neural tensor series of some program $P\in\dP$.
\end{definition}
