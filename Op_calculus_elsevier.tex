...
To define spaces of differentiable programs, let us first recall some
...
\begin{definicija}[Higher derivatives of the programs]
  \label{def:program_derivative_higher}
...
\subsection{Tensor algebra expansion of the virtual memory space}
Let $P:V\to U$ be a map on vector spaces. Motivated by the definitions
\ref{def:program_derivative} and  \ref{def:program_derivative_higher}, we define
