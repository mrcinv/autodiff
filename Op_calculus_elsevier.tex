...
\begin{trditev}
Only explicit knowledge of $\sumd:\dP_0\to\dP_1$ is required for the construction of $\dP_n$. The construction is achieved by following the argument $\eqref{eq:inductionStep}$ of the proof of Theorem \ref{izr:P}, allowing simple implementation, as dictated by $\eqref{eq:potenca(1+d)}$. 
\end{trditev}
