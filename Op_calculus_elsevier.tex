...
\begin{definicija}
  For each program $P$ in the programming space $\F$, we define the \emph{input} or \emph{parameter space} $I_P<\VV$ and the
...
The map $P_e$ describes the actual effect of the
program $P$ ignoring the free memory. 
