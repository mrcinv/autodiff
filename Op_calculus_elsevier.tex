...
\maketitle
\begin{abstract}
In this paper, we develop operational calculus on programming spaces to generalize existing approaches to automatic differentiation and provide a rigorous framework for program analysis through calculus.
