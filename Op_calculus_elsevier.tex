...
\author[fri]{Žiga Sajovic}\ead{ziga.sajovic@gmail.com}
\author[fri]{Martin Vuk \corref{cor}}\ead{martin.vuk@fri.uni-lj.si}
\cortext[cor]{Corresponding author}
\address[fri]{University of Ljubljana, Faculty of Computer and Information
...
\end{abstract}
\begin{keyword}
  programming spaces\sep
  operational calculus\sep
  differentiable programs\sep
  neural networks\sep
  tensor calculus\sep
  program analysis

  \MSC[2010]  47L99\sep 47-04 \sep 46N99\sep  26B40 \sep 26B12
\end{keyword}
\maketitle
...
Let us define the following function spaces.
 ...
 \end{equation}
All of these function spaces are can be seen as subspaces of $\F_\infty=\{f:\VV\to \VV\otimes
T(\VV^*)\}$. The space $\F_n$ is direct a sum of $\F^k$ for $k\le n$ and
$\F_n<\F_m$ if $n<m$.  
...
The derivative defines an operator on the space of smooth maps $\VV\to \VV\otimes
 ...
 applied to $P$. Thus $\D^k$ is a mapping between function spaces $\eqref{eq:F^n}$
...
We seek to generalize such notions of differentiable programing space to spaces
