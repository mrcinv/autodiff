...
implement a generalized shift operator in
...
Such a calculus connects deep learning with general program analysis, through operators that map both formulations to the same space and establish an equivalence between the two.
Several possible applications to computer science are
presented, most notably a meaningful way of neural network initialization that leads to a process of program boosting. This enables a generalization of existing methods for neural analysis to any computer program, and vice versa.
